...
@section('title', 'PYTHON QUEST: ULTRA GAMIFIED')
...
<style>
  ...
  /* Keep page background consistent with layout */
  body{
    ...
    <div class="stage">
      ...
      <div class="levels-container">
        <div class="level-card">
          ...
          <div class="level-progress"><div class="level-progress-bar"></div></div>
          <div class="level-hint">"Like a rollercoaster going through each car!"</div>
        </div>
        <div class="level-card">
          <span class="level-status locked">LOCKED</span>
          ...
          <div class="level-progress"><div class="level-progress-bar"></div></div>
          <div class="level-hint">"Don't forget to update your condition or you'll loop forever!"</div>
        </div>
        <div class="level-card">
          <span class="level-status locked">LOCKED</span>
          ...
          <div class="level-progress"><div class="level-progress-bar"></div></div>
          <div class="level-hint">"Complete Level 2 or score 85+ on pre-assessment!"</div>
        </div>
      </div>
    </div>
    ...
    <div class="stage">
      ...
      <div class="levels-container">
        <div class="level-card">
          ...
          <div class="level-progress"><div class="level-progress-bar"></div></div>
          <div class="level-hint">"Functions are like magic spells you can reuse!"</div>
        </div>
        <div class="level-card">
          <span class="level-status locked">LOCKED</span>
          ...
          <div class="level-progress"><div class="level-progress-bar"></div></div>
          <div class="level-hint">"Parameters are ingredients for your function spells!"</div>
        </div>
        <div class="level-card">
          <span class="level-status locked">LOCKED</span>
          ...
          <div class="level-progress"><div class="level-progress-bar"></div></div>
          <div class="level-hint">"Return is like the result of your magic spell!"</div>
        </div>
      </div>
    </div>
  </div>
